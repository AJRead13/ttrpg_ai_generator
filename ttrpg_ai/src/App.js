      ...
      messages: [
        {
          role: 'system',
          content:
            'You are a tabletop rpg content description generator. You provide descriptions for items, characters and places based on a prompt, a list of possible keywords, as well as a theme and ruleset. Names that are capitalized should be enclosed in brackets.',
        },
        {
          role: 'user',
        ...
        },
        {
          role: 'system',
          content:
            '[The Sword of Freezing]: a +1 magical longsword made by the giant [Golak stormbane] in the [Fridged North]. On a hit, deals an additional 1d6 frost damage.',
        },
        {
          role: 'user',
